...
(function(dice) {
    ...
    function get_dice_value(dice) {
        ...
        var closest_face =0, closest_angle = Math.PI * 2;
    ...
    this.dice_box.prototype.draw_selector = function() {
        ...
        for (var i = 0, pos = -3; i < that.known_types.length; ++i, ++pos) {
            ...
            dice.position.set(pos * stepw, 0, stepw * 0.5);
            dice.castShadow = true;
    ...
    this.dice_box.prototype.bind_mouse = function(container, passiveSupported, notation_getter, before_roll, after_roll) {
